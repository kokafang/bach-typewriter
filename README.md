...
Bach Typewriter also includes Goldberg Variations note data derived from the Mutopia Project Bach-Gesellschaft source edition, licensed under Creative Commons Attribution-ShareAlike 3.0. See [GoldbergAttribution.txt](Sources/bach-typewriter-swift/Resources/Library/GoldbergAttribution.txt).

应用代码使用 MIT License 开源，详见 [LICENSE](LICENSE)。

Goldberg Variations 音符数据来源于 Mutopia Project 的 Bach-Gesellschaft 版本，按 Creative Commons Attribution-ShareAlike 3.0 署名保留。详见 [GoldbergAttribution.txt](Sources/bach-typewriter-swift/Resources/Library/GoldbergAttribution.txt)。
